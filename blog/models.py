...
class Year(models.Model):
    '''年份'''
    year = models.CharField(unique=True, verbose_name='年份',max_length=4)
...
class Article(models.Model):
    ...
    author = models.CharField(max_length=10, verbose_name='作者',default='祖国万岁',blank=True,null=True)
    desc = models.CharField(max_length=50, verbose_name='文章描述')
    cover = models.URLField(max_length=200, default='https://i1.hdslb.com/bfs/article/986da61cd857a85708ef16f21ecc588e4c7edc5d.jpg@1192w.avif', verbose_name='文章封面')
...
class Site(models.Model):
    ...
    icp_url = models.URLField(default='#',max_length=100, verbose_name='备案链接')
    bg_cover = models.URLField(default='/media/img/003044Cwsr1.jpg',max_length=100,verbose_name='背景图片')
...
class City(models.Model):
    name = models.CharField(max_length=10,verbose_name='城市名',null=True,blank=True)
    value = models.IntegerField(verbose_name='去过的次数',null=True,blank=True)
